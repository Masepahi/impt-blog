...
$(document).ready(function () {
  $(".publishBtn").on("click", function () {
    ...
    let titleContents = document.getElementById('titleEditor').innerHTML
    let bodyContents = document.getElementById('tinyEditor').innerHTML
    ...
    $.ajax({
      ...
      data: {title: titleContents, text: bodyContents},
      dataType: "dataType",
